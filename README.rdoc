...
* Update `buildlight.plist` with your home path
* Copy the plist to the right location

    cp buildlight.plist ~/Library/LaunchAgents/buildlight.plist

* Update `run_service.sh` with your home directory
* Install the script

    launchctl load -w ~/Library/LaunchAgents/buildlight.plist
